...
```{r, forest_growing, echo=TRUE, cache=TRUE}
...
As is evident from the **Confusion Matrix**, despite the simplicity of our model our results are very good.  **Random forests** do often run the risk of *over-fitting*.
